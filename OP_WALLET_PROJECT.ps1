...
# ---> .\OP_WALLET_PROJECT.ps1 <laptop name>
...
mkdir LOCAL_OPTIMISM_PROJECT_ENV

cd LOCAL_OPTIMISM_PROJECT_ENV
...
echo 'LOCAL_OPTIMISM_PROJECT_ENV project setup is complete!'