...
export async function POST(request: Request){
    ...
    const response = await fetch('https://deep-index.moralis.io/api/v2.2/wallets/' + body.walletAddress + '/chains?chains%5B0%5D=optimism', options) // Pass in address values for request
