        ...
        <footer className="pt-5 footer">
            <div className="container">
                <p className="copyright-paragraph">
                    <a style={{ color:'black' }} href="https://docs.alchemy.com/" target="_blank" rel="noreferrer"><img style={{ marginRight: '0.15rem' }} src={require("../../assets/images/alchemy.png")} width="25" height="25" alt="logo" />Alchemy</a><span style={{ marginLeft: '0.25rem', marginRight: '0.25rem' }}></span><b>|</b>
                    ...
                    <a style={{ color:'black' }} href="https://optimistic.etherscan.io/" target="_blank" rel="noreferrer"><img style={{ marginRight: '0.25rem' }} src={ require("../../assets/images/optimism.png") } width="25" height="25" alt="logo" />OP Etherscan</a><span style={{ marginLeft: '0.25rem', marginRight: '0.25rem' }}></span>
                </p>
