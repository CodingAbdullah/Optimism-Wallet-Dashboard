...
import WalletBalanceInfoTable from './WalletBalanceInfoTable';
import WalletStatsInfoTable from './WalletStatsInfoTable';
import WalletHistoryInfoTable from './WalletHistoryInfoTable';
...
export default function WalletAnalyticsForm() {
    ...
    return (
        <>
            ...
            { tableStatus ? <WalletBalanceInfoTable address={walletAddressRef.current!.value.trim()} /> : null }
            { tableStatus ? <WalletHistoryInfoTable address={walletAddressRef.current!.value.trim()} /> : null }
